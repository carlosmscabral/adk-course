...
- [Sandbox bypass classes — the executor-agnostic threat model](Notes/12_CodeExecution/02A_SandboxBypassClasses.md)
...
- [ContainerCodeExecutor — your Docker daemon as the sandbox](Notes/12_CodeExecution/05_ContainerCodeExecutor.md)
- [GkeCodeExecutor — pods on your cluster](Notes/12_CodeExecution/05A_GkeCodeExecutor.md)
- [AgentEngineSandboxCodeExecutor — the Agent-Engine-native sandbox](Notes/12_CodeExecution/06_AgentEngineSandbox.md)
