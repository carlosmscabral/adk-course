...
- `sub_agents=` + `description`: [Notes/05_MultiAgent/02_SubAgents](../../Notes/05_MultiAgent/02_SubAgents.md)
- `instruction` templating: [Notes/04_SessionsState/03_ReadingStateInPrompts](../../Notes/04_SessionsState/03_ReadingStateInPrompts.md)
